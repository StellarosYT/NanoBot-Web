  ...
  <div class="wrapper">
    ...
    -->
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          <li class="active ">
            <a href="https://www.mythigame/dashboard">
    ...
    <div class="main-panel">
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright">
          <a href="https://www.mythigame.net/">MythiGame Community - MGC 2019-<script>document.write(new Date().getFullYear())</script> Tous droits réservés.</a>
          </div>
        </div>
      </footer>
    </div>
